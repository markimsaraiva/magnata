...
local dodge = { 
    {min = 1, max = 2, chance = 5}, -- se o dodge tiver entre 1 e 2 tem 10% de chance de da dodge.
    {min = 3, max = 4, chance = 6}, -- podem ser configurada portanto que não passe do limite
    {min = 5, max = 6, chance = 7}, -- vocês pode adicionar mas se quiserem
    {min = 7, max = 8, chance = 8},
    {min = 9, max = 10, chance = 9},
    {min = 11, max = math.huge, chance = 10}
}
