...
local texto = "Você Almentou Sua Experiencia em 5x por 2 Horas" -- Texto que irá receber ao usar a potion.
textofinal = "Acabou o potion de Experiencia." -- Texto que irá receber quando o efeito da potion acabar.
local exp = 5 -- O quanto que você quer que dobre sua experiencia, por exemplo 2 é 2x as rates do seu server.
...
local seuitem = 8981 -- seu item que dará double exp
local efeito1 = 14 -- efeito que ficara com o char por meia hora
local efeito2 = 30 -- efeito que acontecera no momento que usar a pot
