...
local POTIONS = { 
        ...
        [8473] = {empty = 7635, splash = 2, health = {4000, 5000}, level = 130, vocations = {4, 8,12}, vocStr = "knights"}, -- ultimate health potion 
        [7620] = {empty = 7636, splash = 7, mana = {400, 600}}, -- mana potion 
        [7589] = {empty = 7634, splash = 7, mana = {1000, 2000}, level = 50, vocations = {3, 7,11}, vocStr = "paladins"}, -- strong mana potion 
        [7590] = {empty = 7635, splash = 7, mana = {4000, 7600}, level = 80, vocations = {1, 2, 5, 6,9,10}, vocStr = "sorcerers and druids"}, -- great mana potion 
        [7439] = {empty = 7439, splash = 7, mana = {1700, 2000}, level = 80, vocations = {1, 2, 5, 6,9,10}, vocStr = "sorcerers and druids"}, -- super mana potion 
        [8472] = {empty = 7635, splash = 3, health = {3100, 3200}, mana = {4000, 7600}, level = 80, vocations = {3, 7,11}, vocStr = "paladins"} -- great spirit potion 
} 
