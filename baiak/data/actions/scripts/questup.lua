...
storage = 938314 -- Storage a cada quest que for criada aumente um numero da storage pra qnd vc pegar o baú de outra quest ñ aparecer que vc já fez.
item = 9019 -- Id do item ira ganhar.
...
doPlayerSendTextMessage(cid,25,"Você ganhou um SuperUP Area") -- Mensagem que aparecera quando ganhar o item.
...
doPlayerSendTextMessage(cid,25,"Você precisa ser level 1000 ou mais.") -- Mensagem que ira aparecer se o player tiver menos level que o necessario.
