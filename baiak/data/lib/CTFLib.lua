...
CTF_LIB = {
	waitpos = {x = 303, y = 360, z =7}, -- Posição da sala de espera
	tppos = {x = 161, y = 55, z =7}, -- Onde o TP vai aparecer
	...
	teams = {
		["Vermelho"] = {
			...
			flag = {
				id = 1435,
				flag_pos = {x = 293, y = 318, z =7}, -- Posição onde a bandeira vermelha vai ser criada
				gnd_pos = {x = 321, y = 312, z =7}, -- Onde os players da equipe vermelha entregarão a bandeira.
			},
		},
		...
		["Verde"] = {
			...
			flag = {
				id = 1437,
				flag_pos = {x = 345, y = 319, z =7}, -- Posição onde a bandeira verde vai ser criada
				gnd_pos = {x = 316, y = 337, z =7}, -- Onde os players da equipe verde entregarão a bandeira.
			},
		},
	},
}
